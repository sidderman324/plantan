...
<head>
	...
	<title>Листовая диагностика - консультативно-экспертный анализ растений в Краснодарском крае и Краснодаре.</title>
...
<body>
	...
	<?php include ($_SERVER['DOCUMENT_ROOT'] . '/_include/header.php');?>
			...
			<div class="container">
				...
				<div class="link_block">
					<a href="#" class="link_card">
						<span>яблоки</span>
						<img src="/static/imgs/program_apple.jpg" alt="">
					</a>
					<a href="#" class="link_card">
						<span>виноград</span>
						<img src="/static/imgs/program_grape.jpg" alt="">
					</a>
				</div>
				...
				<div class="link_block">
					<a href="#" class="link_card">
						<span>клубника</span>
						<img src="/static/imgs/program_strawberry.jpg" alt="">
					</a>
					<a href="#" class="link_card">
						<span>пшеница</span>
						<img src="/static/imgs/program_wheat.jpg" alt="">
					</a>
				</div>
				...
				<div class="link_block">
					<a href="#" class="link_card link_card--big">
						...
						<img src="/static/imgs/program_veg.jpg" alt="">
					</a>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="left_block">
						<h2><span class="bold">О лаборатории</span><br>«Листовая диагностика»</h2>
						<a href="#" class="btn btn--transparent">Подробнее</a>
					</div>

					<div class="img_wrapper">
						<img src="/static/imgs/microscope.png" alt="">
					</div>
		...
		<section class="feedback">
			<div class="container">
				...
				<form action="" method="POST">
					<div class="input_box">
						<input type="text" class="input_text" name="name" placeholder="Ваше имя">
					</div>
					<div class="input_box">
						<input type="text" class="input_text" name="phone" placeholder="Телефон">
					</div>
					<div class="input_box">
						<input type="text" class="input_text" name="mail" placeholder="E-mail">
					</div>
					<div class="custom_checkbox">
			      <input id="confirmation" type="checkbox">
			      <label for="confirmation" name="confirmation"><span>Я согласен на <a href="#">обработку персональных данных</a></span></label>
			    </div>
	...
	<?php include ($_SERVER['DOCUMENT_ROOT'] . '/_include/footer.php');?>
	<?php include ($_SERVER['DOCUMENT_ROOT'] . '/_include/svg_icons.php');?>
